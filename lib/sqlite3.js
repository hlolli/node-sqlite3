...
var embedded_files = lumo.internal.embedded.keys();
var embedded_binary_path = embedded_files.filter(function(item){
    return /node_sqlite3.node$/.test(item);
});

var binding_path;
console.log('INDEX OF closh/main.cljs:', embedded_files.indexOf('closh/main.cljs'));
if (embedded_files.indexOf('closh/main.cljs') > -1) {
  binding_path = embedded_binary_path[0];
} else {
